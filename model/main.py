...
poem_model, poem_word2idx, poem_idx2word = load_resources_poem(
    model_path="app/model_poem/model/poem_lstm.pth",
    poem_word2idx_path="app/model_poem/model/poem_word2idx.pkl",
    poem_idx2word_path="app/model_poem/model/poem_idx2word.pkl"
)

# ================== Load Model Pantun ==================
pantun_model, pantun_word2idx, pantun_idx2word = load_resources_pantun(
    model_path="app/model_pantun/model_pan_pth/pantun_lstm.pth",
    pantun_word2idx_path="app/model_pantun/model1/pantun_word2idx.pkl",
    pantun_idx2word_path = "app/model_pantun/model1/pantun_idx2word.pkl"
    )
